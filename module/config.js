...
HM3.stdSkills = {
    ...
    "Shield": { "source": "HM3 Skills 19", "skillBase": { "formula": "@str, @dex, @dex, Ulandus, Tollan, Chuán, Masara" }, "type": "Combat" },
    ...
    "Unarmed": { "source": "HM3 Skills 18", "skillBase": { "formula": "@str, @dex, @agl, Madada:2, Tollan:2, Chuán:2, Ulandus:2" }, "type": "Combat" },
    ...
    "Net": { "source": "HM3 Skills 19", "skillBase": { "formula": "@dex, @dex, @eye, Masara, Skorus, Tollan, Chuán" }, "type": "Combat" },
    ...
    "Fishing": { "source": "HM3 Skills 14", "skillBase": { "formula": "@dex, @eye, @wil, Masara:2, Tollan:2, Chuán:2" }, "type": "Craft" },
    ...
    "Piloting": { "source": "HM3 Skills 17", "skillBase": { "formula": "@dex, @eye, @int, Tollan:3, Chuán:3, Masara" }, "type": "Craft" },
    "Weatherlore": { "source": "HM3 Skills 17", "skillBase": { "formula": "@int, @eye, @sml, Hirin, Tarael, Masada, Tollan, Chuán" }, "type": "Craft" },
    ...
    "Shipwright": { "source": "HM3 Skills 17", "skillBase": { "formula": "@str, @dex, @int, Tollan:3, Chuán:3, Masara" }, "type": "Craft" },
    "Astrology": { "source": "HM3 Skills 13", "skillBase": { "formula": "@eye, @int, @aur, Tarael" }, "type": "Craft" },
    "Woodcraft": { "source": "HM3 Skills 17", "skillBase": { "formula": "@dex, @dex, @wil, Ulandus:2, Aralius, Tollan, Chuán" }, "type": "Craft" },
    ...
    "Seamanship": { "source": "HM3 Skills 17", "skillBase": { "formula": "@str, @dex, @agl, Tollan:3, Chuán:3, Masara, Skorus" }, "type": "Craft" },
    ...
    "Lyahvi": { "source": "HM Magic, Shek-Pvar 6", "skillBase": { "formula": "@aur, @aur, @eye, Ulandus:-3, Aralius:-2,Feneri:-1, Angberelius, Nadai:2, Hirin:3, Tarael:2, Tai,Masara:-1, Tollan:-2" }, "type": "Magic" },
    ...
    "Peleahn": { "source": "HM Magic, Shek-pvar 6", "skillBase": { "formula": "@aur, @aur, @agl, Ulandus:-1, Feneri, Ahnu:2, Angberelius:3, Nadai:2, Hirin, Tai:-1, Skorus:-2, Masara:-3, Tollan:-2" }, "type": "Magic" },
    ...
    "Odivshe": { "source": "HM Magic, Shek-pvar 6", "skillBase": { "formula": "@aur, @aur, @dex, Ulandus, Feneri:-1, Ahnu:-2, Angberelius:-3, Nadai:-2, Hirin:-1, Tai:1, Skorus:2, Masara:3, Tollan:2, Chuán:2" }, "type": "Magic" },
    "Neutral": { "source": "HM Magic, Shek-pvar 6", "skillBase": { "formula": "@aur, @aur, @wil" }, "type": "Magic" },
    "Fyvria": { "source": "HM Magic, Shek-pvar 6", "skillBase": { "formula": "@aur, @aur, @sml, Ulandus:3, Aralius:2, Feneri:1, Angberelius:-1, Nadai:-2, Hirin:-3, Tarael:-2, Tai:-1, Masara, Tollan:2, Chuán:2" }, "type": "Magic" },
    "Climbing": { "source": "HM3 Skills 8", "skillBase": { "formula": "@str, @dex, @agl, Ulandus:2, Aralius:2" }, "type": "Physical" },
    "Swimming": { "source": "HM3 Skills 9", "skillBase": { "formula": "@sta, @dex, @agl, Skorus, Masara:3, Tollan:3, Chuán:3" }, "type": "Physical" },
    "Skiing": { "source": "HM3 Skills 9", "skillBase": { "formula": "@str, @dex, @agl, Masara:2, Skorus, Tollan, Chuán" }, "type": "Physical" },
    ...
    "Condition": { "source": "HM3 Skills 9", "skillBase": { "formula": "@str, @sta, @wil, Ulandus, Tollan, Chuán" }, "type": "Physical" },
    ...
    "Sarajin": { "source": "HM Religion, Sarajin 1", "skillBase": { "formula": "@voi, @int, @str, Feniri:2, Aralius, Tollan, Chuán" }, "type": "Ritual" },
    "Morgath": { "source": "HM Religion, Morgath 1", "skillBase": { "formula": "@voi, @int, @aur, Tollan:2, Chuán:2, Ahnu, Masara" }, "type": "Ritual" },
