...
HM3.stdSkills = {
    ...
    "Axe": { "source": "HM3 Skills 19", "skillBase": { "formula": "@str, @str, @dex, Izballa, Zosan-shi, Anzor, Aramos, Lengjing" }, "type": "Combat" },
    ...
    "Spear": { "source": "HM3 Skills 19", "skillBase": { "formula": "@str, @str, @dex, Ariala, Boru, Anzor, Syrada, Jig-won" }, "type": "Combat" },
    ...
    "Rhetoric": { "source": "HM3 Skills 12", "skillBase": { "formula": "@voi, @int, @wil, Zhone, Yong, Torka, Yari, Quindor, Feniku, Feniku" }, "type": "Communication" },
    "Language": { "source": "HM3 Skills 10", "skillBase": { "formula": "@voi, @int, @wil, Zhone, Yong" }, "type": "Communication" },
    "Musician": { "source": "HM3 Skills 12", "skillBase": { "formula": "@dex, @hrg, @hrg, Dorma, Shuchi, Aramos, Lengjing" }, "type": "Communication" },
    ...
    "Lovecraft": { "source": "HM3 Skills 11", "skillBase": { "formula": "@cml, @agl, @voi, Dorma, Shuchi, Aramos, Lengjing" }, "type": "Communication" },
    "Physician": { "source": "HM3 Skills 17", "skillBase": { "formula": "@dex, @eye, @int, Dorma:2, Shuchi:2, Quindor, Feniku, Zhone, Yong" }, "type": "Craft" },
    "Fishing": { "source": "HM3 Skills 14", "skillBase": { "formula": "@dex, @eye, @wil, Dorma:2, Shuchi:2, Tollan:2, Chuán:2" }, "type": "Craft" },
    ...
    "Mathematics": { "source": "HM3 Skills 16", "skillBase": { "formula": "@int, @int, @wil, Zhone:3, Yong:3, Torka, Yari, Quindor, Feniku, Feniku" }, "type": "Craft" },
    "Folklore": { "source": "HM3 Skills 15", "skillBase": { "formula": "@voi, @int, @int, Zhone:2, Yong:2" }, "type": "Craft" },
    "Jewelcraft": { "source": "HM3 Skills 16", "skillBase": { "formula": "@dex, @eye, @wil, Anzor:3, Torka, Yari, Ariala, Boru" }, "type": "Craft" },
    "Tracking": { "source": "HM3 Skills 17", "skillBase": { "formula": "@eye, @sml, @wil, Syrada:3, Jig-won:3, Ariala:3, Boru:3" }, "type": "Craft" },
    ...
    "Weaponcraft": { "source": "HM3 Skills 17", "skillBase": { "formula": "@str, @dex, @wil, Anzor:3, Izballa, Zosan-shi, Aramos, Lengjing" }, "type": "Craft" },
    "Mining": { "source": "HM3 Skills 16", "skillBase": { "formula": "@str, @eye, @int, Syrada:2, Jig-won:2, Ariala:2, Boru:2, Anzor" }, "type": "Craft" },
    "Metalcraft": { "source": "HM3 Skills 16", "skillBase": { "formula": "@str, @dex, @wil, Anzor:3, Izballa, Zosan-shi, Aramos, Lengjing" }, "type": "Craft" },
    "Ceramics": { "source": "HM3 Skills 13", "skillBase": { "formula": "@dex, @dex, @eye, Syrada:2, Jig-won:2, Ariala:2, Boru:2" }, "type": "Craft" },
    "Runecraft": { "source": "HM3 Skills 17", "skillBase": { "formula": "@int, @aur, @aur, Zhone:2, Yong:2, Quindor, Feniku, Feniku" }, "type": "Craft" },
    ...
    "Fletching": { "source": "HM3 Skills 15", "skillBase": { "formula": "@dex, @dex, @eye, Gordol:2, Ying:2, Torka, Yari, Caelaz, Sanyang" }, "type": "Craft" },
    "Piloting": { "source": "HM3 Skills 17", "skillBase": { "formula": "@dex, @eye, @int, Tollan:3, Chuán:3, Dorma, Shuchi" }, "type": "Craft" },
    "Weatherlore": { "source": "HM3 Skills 17", "skillBase": { "formula": "@int, @eye, @sml, Gordol, Ying, Torka, Yari, Masada, Tollan, Chuán" }, "type": "Craft" },
    "Engineering": { "source": "HM3 Skills 14", "skillBase": { "formula": "@dex, @int, @int, Syrada:2, Jig-won:2, Ariala:2, Boru:2, Anzor" }, "type": "Craft" },
    "Embalming": { "source": "HM3 Skills 14", "skillBase": { "formula": "@dex, @eye, @sml, Quindor, Feniku, Syrada, Jig-won" }, "type": "Craft" },
    "Brewing": { "source": "HM3 Skills 13", "skillBase": { "formula": "@dex, @sml, @sml, Quindor:3, Feniku:3, Zhone:2, Yong:2, Dorma:2, Shuchi:2" }, "type": "Craft" },
    "Lockcraft": { "source": "HM3 Skills 16", "skillBase": { "formula": "@dex, @eye, @wil, Anzor" }, "type": "Craft" },
    "Masonry": { "source": "HM3 Skills 16", "skillBase": { "formula": "@str, @dex, @int, Syrada:2, Jig-won:2, Ariala:2, Boru:2" }, "type": "Craft" },
    "Textilecraft": { "source": "HM3 Skills 17", "skillBase": { "formula": "@dex, @dex, @eye, Syrada, Jig-won, Ariala, Boru" }, "type": "Craft" },
    "Cookery": { "source": "HM3 Skills 13", "skillBase": { "formula": "@dex, @sml, @sml, Quindor, Feniku, Feniku" }, "type": "Craft" },
    "Lore": { "source": "HM3 Skills 16", "skillBase": { "formula": "@eye, @int, @int, Zhone:2, Yong:2" }, "type": "Craft" },
    "Drawing": { "source": "HM3 Skills 13", "skillBase": { "formula": "@dex, @eye, @eye, Quindor, Feniku, Zhone, Yong" }, "type": "Craft" },
    "Alchemy": { "source": "HM3 Skills 13", "skillBase": { "formula": "@sml, @int, @aur, Quindor:3, Feniku:3, Zhone:2, Yong:2, Dorma:2, Shuchi:2" }, "type": "Craft" },
    "Milling": { "source": "HM3 Skills 16", "skillBase": { "formula": "@str, @dex, @sml, Syrada, Jig-won" }, "type": "Craft" },
    "Timbercraft": { "source": "HM3 Skills 17", "skillBase": { "formula": "@str, @dex, @agl, Syrada:3, Jig-won:3, Ariala, Boru" }, "type": "Craft" },
    "Hidework": { "source": "HM3 Skills 15", "skillBase": { "formula": "@dex, @sml, @wil, Ulandis, Ariala, Boru" }, "type": "Craft" },
    "Shipwright": { "source": "HM3 Skills 17", "skillBase": { "formula": "@str, @dex, @int, Tollan:3, Chuán:3, Dorma, Shuchi" }, "type": "Craft" },
    "Astrology": { "source": "HM3 Skills 13", "skillBase": { "formula": "@eye, @int, @aur, Torka, Yari" }, "type": "Craft" },
    ...
    "Heraldry": { "source": "HM3 Skills 15", "skillBase": { "formula": "@dex, @eye, @wil, Quindor, Feniku, Zhone, Yong" }, "type": "Craft" },
    "Animalcraft": { "source": "HM3 Skills 13", "skillBase": { "formula": "@agl, @voi, @wil, Syrada, Jig-won, Ariala, Boru" }, "type": "Craft" },
    "Seamanship": { "source": "HM3 Skills 17", "skillBase": { "formula": "@str, @dex, @agl, Tollan:3, Chuán:3, Dorma, Shuchi, Quindor, Feniku, Feniku" }, "type": "Craft" },
    "Glassworking": { "source": "HM3 Skills 15", "skillBase": { "formula": "@dex, @eye, @wil, Anzor:2" }, "type": "Craft" },
    "Agriculture": { "source": "HM3 Skills 13", "skillBase": { "formula": "@str, @sta, @wil, Syrada:2, Jig-won:2, Ariala:2, Boru:2" }, "type": "Craft" },
    "Lyahvi": { "source": "HM Magic, Shek-Pvar 6", "skillBase": { "formula": "@aur, @aur, @eye, Syrada:-3, Jig-won:-3, Ariala:-2, Boru:-2,Anzor:-1, Aramos, Lengjing, Caelaz:2, Sanyang:2, Gordol:3, Ying:3, Torka:2, Yari:2, Zhone, Yong,Dorma:-1, Shuchi:-1, Tollan:-2, Chuán:-2" }, "type": "Magic" },
    ...
    "Odivshe": { "source": "HM Magic, Shek-pvar 6", "skillBase": { "formula": "@aur, @aur, @dex, Syrada, Jig-won, Anzor:-1, Izballa:-2,Zosan-shi:-2, Aramos:-3, Lengjing:-3, Caelaz:-2, Sanyang:-2, Gordol:-1, Ying:-1, Zhone:1, Quindor:2, Feniku:2, Dorma:3, Shuchi:3, Tollan:2, Chuán:2" }, "type": "Magic" },
    "Neutral": { "source": "HM Magic, Shek-pvar 6", "skillBase": { "formula": "@aur, @aur, @wil" }, "type": "Magic" },
    "Fyvria": { "source": "HM Magic, Shek-pvar 6", "skillBase": { "formula": "@aur, @aur, @sml, Syrada:3, Jig-won:3, Ariala:2, Boru:2, Anzor:1, Aramos:-1, Lengjing:-1, Caelaz:-2, Sanyang:-2, Gordol:-3, Ying:-3, Torka:-2, Yari:-2, Zhone:-1, Yong:-1, Dorma, Shuchi, Tollan:2, Chuán:2" }, "type": "Magic" },
    ...
    "Agrik": { "source": "HM Religion, Agrik 1", "skillBase": { "formula": "@voi, @int, @str, Caelaz:2, Sanyang:2, Aramos, Lengjing, Izballa, Zosan-shi" }, "type": "Ritual" },
    "Ilvir": { "source": "HM Religion, Ilvir 1", "skillBase": { "formula": "@voi, @int, @aur, Quindor:2, Feniku:2, Zhone, Yong, Syrada, Jig-won" }, "type": "Ritual" },
    "Siem": { "source": "HM Religion, Siem 1", "skillBase": { "formula": "@voi, @int, @aur, Gordol:2, Ying:2, Anzor, Syrada, Jig-won" }, "type": "Ritual" },
    "Sarajin": { "source": "HM Religion, Sarajin 1", "skillBase": { "formula": "@voi, @int, @str, Anzor:2, Ariala, Boru, Tollan, Chuán" }, "type": "Ritual" },
    ...
    "Larani": { "source": "HM Religion, Larani 1", "skillBase": { "formula": "@voi, @int, @wil, Aramos:2, Lengjing:2, Izballa, Zosan-shi, Anzor" }, "type": "Ritual" },
    "Save K'nor": { "source": "HM Religion, Save K'nor 1", "skillBase": { "formula": "@voi, @int, @int, Zhone:2, Yong:2, Torka, Yari, Quindor, Feniku, Feniku" }, "type": "Craft" }
};
